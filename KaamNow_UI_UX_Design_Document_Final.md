...
**Version:** 2.0  
**Status:** Final / Design Source of Truth  
**Platform:** Android Mobile App + Creator/Admin Web Portal
...
The palette does not contain a dedicated light background, therefore the app should use a warm neutral background derived from the design system.
